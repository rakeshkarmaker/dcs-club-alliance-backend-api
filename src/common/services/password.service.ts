  ...
  async hassPassword(password: string): Promise<string> {
    ...
    if (!this.checkPasswordStrength(password))
      throw new BadRequestException(
        'Password does not meet strength requirements. It must be at least 8 characters long and include uppercase letters, lowercase letters, numbers, and special characters.',
      );
